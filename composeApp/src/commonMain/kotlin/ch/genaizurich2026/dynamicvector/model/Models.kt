...
data class Context(
    ...
    val sourceConfig: ContextSourceConfig,
    val questions: List<ContextQuestion>,
    val resultSchema: List<ResultFieldSchema>,
...
data class ContextComposition(
    val id: String,
    val name: String,
    val type: ContextCompositionType,
...
/**
 * A user's answer to a [ContextQuestion].
 */
...
data class ContextQuery(
    ...
    val name: String,
    val contextIds: List<String>,
    val composition: ContextComposition? = null,
    val answers: List<ContextAnswer>,
...
data class ContextResultSet(
    val queryId: String,
    val items: List<ContextResultItem>,
    val totalCount: Int,
    val suggestedRefinements: List<ContextQuestion>,
